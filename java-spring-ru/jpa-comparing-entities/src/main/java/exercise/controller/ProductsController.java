...
//    public Product show(@RequestBody Product product) {
//       productRepository.findById(product.getId())
//                .orElseThrow(() -> new ResourceAlreadyExistsException("Product with id " + product.getId() + " not found"));
//
...
//            throw new ResourceAlreadyExistsException("Product with id " + product.getId() + " not found");
//        } else {
//        return productRepository.save(product);}
//
//    }
